...
跑 `samples/devices/camera_black_screen_cases.json` 中的固定子案例，
...
JSON_PATH = OUTPUT_DIR / "phase1-camera-black-screen-eval.json"
MD_PATH = OUTPUT_DIR / "phase1-camera-black-screen-eval.md"
CASE_REPORT_DIR = OUTPUT_DIR / "phase1-cases"

REVIEWER = "eval-harness"
DESCRIPTION = "摄像头预览黑屏，需要定位根因"
