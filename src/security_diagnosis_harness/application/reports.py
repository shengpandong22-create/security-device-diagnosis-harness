...
def render_markdown_report(
    ...
    if case.conclusion is None:
        ...
        lines += [
            ...
            f"- model_candidate_label: {conclusion.model_candidate_label or '（未提供）'}",
            f"- rule_candidate_label: {conclusion.rule_candidate_label or '（未计算）'}",
            f"- rule_consistency: `{conclusion.rule_consistency}`",
