...
本文聚焦多 Agent 协作协议和经济性。项目从 Phase 0 到 Phase 11 的完整成长过程、架构方法、
验收体系和严格审计反思，见[从 0 到 1 构建可信诊断 Agent：我的成长、方法与反思](./从0到1构建可信诊断Agent的成长与反思.md)。
长会话的上下文成本、线程切分与最小接力协议，见[长会话上下文膨胀与任务接力复盘](./长会话上下文膨胀与任务接力复盘.md)。
